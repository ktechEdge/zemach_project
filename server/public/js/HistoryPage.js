...
//                 if (plantNameValue !== plantNameValue) matches = false;
//                 if (measurementDate && new Date(plant.measurement_date).toLocaleDateString() !== new Date(measurementDate).toLocaleDateString())matches = false;
//
//                 return matches;
//             });
//
